...
<nav class="navbar-fixed navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Get Your Pet</a>
    </div>
...
<div class="row" >
  ...
  <div class="col-md-3">
                <legend>Filter by category</legend>
                        ...
                        <input type="checkbox" name="category[]" value="Cow" />Cow
                        <input type="checkbox" name="category[]" value="OX" />OX
                        <input type="checkbox" name="category[]" value="Buffallo" />Buffallo
            ...
            <div class="col-md-3">
				<legend>Filter by Area</legend>
						...
						<option  value="Kholpaur">Kholpaur</option>
						<option  value="Ratnigiri">Ratnigiri</option>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-6 footerleft ">
        <div class="logofooter"> Get Your Pet Corp Inc.</div>
        <p>Get Your Pet is an online Classified Portal , where buyer meets the seller !</p>
        <p><i class="fa fa-map-pin"></i> Samshan Gali, Khatra Mahal , Andher nagar, Samshan Ke Samne 12123.</p>
        <p><i class="fa fa-phone"></i> Phone (India) : +91 9768353616</p>
        <p><i class="fa fa-envelope"></i> E-mail : info@getyourpet.com</p>
